    ...
    return (
        <div className="grid grid-cols-4 gap-4 md:gap-8">
            ...
            <div className="col-span-4 md:col-span-3 mt-8 py-4">
                <h2 className="text-lg font-semibold py-2">Website load times</h2>
                <small className="text-gray-400 block mb-2 text-right">*Click on table header to sort by that field</small>
